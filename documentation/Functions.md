...
3. This requires devonfw-ide to be installed for their execution.

4. This command also works if the devonfw-ide is not installed, but then you have to make sure that the Angular CLI is installed.
